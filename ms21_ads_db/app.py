...
@app.route('/add_ads_db', methods=["GET","POST"])
def add_ads():
    log_this(request)
    # response = app.ms.requests.get("http://10.5.16.212:9016/check_admin")
    # response = app.ms.requests.get("http://10.5.16.212:9007/add_ads")
    return "ads added"


# Run the app
if __name__ == '__main__':
    app.run(debug=True,host="0.0.0.0",port=9021)