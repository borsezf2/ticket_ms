...
def search_train():
    log_this(request)
    response = app.ms.requests.get("http://10.5.16.212:9007/search_train_db")
    response = app.ms.requests.get("http://10.5.16.212:9010/update_base_price")
    response = app.ms.requests.get("http://10.5.16.212:9011/discount_sub")
